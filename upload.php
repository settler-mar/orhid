...
move_uploaded_file($_FILES['upload']['tmp_name'], "img/staticPages/".$name);
$full_path = 'orhid/img/staticPages/'.$name;
$message = "Файл ".$_FILES['upload']['name']." загружен";
$size=@getimagesize('img/staticPages/'.$name);
if($size[0]<50 OR $size[1]<50){
unlink('img/staticPages/'.$name);
