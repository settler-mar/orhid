...
/**
 * ShopController implements the CRUD actions for ShopStore model.
 */
class ShopController extends Controller
{
    ...
    /**
     * Displays a single ShopStore model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Updates an existing ShopStore model.
    ...
    /**
     * Deletes an existing ShopStore model.
    ...
    /**
     * Finds the ShopStore model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return ShopStore the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = ShopStore::findOne($id)) !== null) {
            return $model;
        } else {
